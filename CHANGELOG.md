...
- Json parsing with invalid chars like `\u0000` preventing some channels from loading

## [0.44.2] - 2025-11-13

### Fixed

- Removed retry on trending feeds
...
- Implemented compactRadioRenderer node
...
- Another mistake in OTF streams

## [0.43.8] - 2025-11-07

### Fixed

- Fix in url decipher logic
- Redo OTF segment processing

## [0.43.7] - 2025-11-06

### Fixed

- Adjust telemetry for OTF streams to debug

## [0.43.6] - 2025-11-06

### Fixed

- Bug in processing OTF streams info
...
- Improve channel parsing in Recommended feed

## [0.43.2] - 2025-10-29

### Fixed

- Crash on older Roku OS version due to `roByteArray.Slice` not being available

## [0.43.1] - 2025-10-28

### Added

- Support for additional nodes parsing

### Fixed

- Trickplay storyboards on DRM videos
...
- Crash when trying to display error messages with very long text
...
- Crash when logging early startup warnings
